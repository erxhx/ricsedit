  ...
  function StepService(props) {
    ...
    return (
      <div>
        ...
        {selected.length > 0 && (
          <div ref={ctaRef} style={{ position: 'sticky', bottom: 0, background: 'var(--bg)', paddingBottom: 20, marginTop: 4 }}>
      ...
      <div>
        ...
        {showPicker ? (
          ...
          <div>
            ...
            <div style={{ position: 'sticky', bottom: 0, background: 'var(--bg)', paddingBottom: 20, marginTop: 4 }}>
