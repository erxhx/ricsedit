(() => {
  ...
  function Hero({ data, animComp, progress, speed, service }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "panel" }, /* @__PURE__ */ React.createElement(Anim, { progress, speed }), /* @__PURE__ */ React.createElement("div", { className: "hero", "data-service": service, style: { padding: "0px 56px 110px 80px" } }, data.h1 && /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: "sans-serif", margin: "0px" } }, data.h1), service === "home" && /* @__PURE__ */ React.createElement(HomeCollage, null), data.sub && /* @__PURE__ */ React.createElement("p", { className: "sub", style: { margin: "22px 0px 14px 5px" } }, data.sub), /* @__PURE__ */ React.createElement("div", { className: "swipe-hint", style: { margin: "28px 0px 0px 10px" } }, /* @__PURE__ */ React.createElement("span", { className: "glyph" }), /* @__PURE__ */ React.createElement("span", null, data.cta)), /* @__PURE__ */ React.createElement(
      "a",
      {
        className: "book",
        href: "#book",
