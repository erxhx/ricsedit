(() => {
  (function() {
    ...
    function StepConfirm(props) {
      ...
      }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", padding: "6px 0 2px", marginTop: 4, borderTop: "1px solid var(--rule)", fontSize: 13 } }, /* @__PURE__ */ React.createElement("span", null, "Due now"), /* @__PURE__ */ React.createElement("span", null, bkFmtPrice(finalCents / 100)))), showApplePay && /* @__PURE__ */ React.createElement(
        "button",
        {
          type: "button",
      ...
      ), showApplePay && showCardForm && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 14, margin: "16px 2px" } }, /* @__PURE__ */ React.createElement("span", { style: { flex: 1, height: 1, background: "var(--rule)" } }), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--mono)", fontSize: 11, letterSpacing: "0.14em", color: "var(--ink-faint)", textTransform: "uppercase" } }, "or"), /* @__PURE__ */ React.createElement("span", { style: { flex: 1, height: 1, background: "var(--rule)" } })), showCardForm && /* @__PURE__ */ React.createElement("div", { style: { border: "1px solid var(--rule)", padding: "14px 14px 2px", background: "var(--paper)" } }, /* @__PURE__ */ React.createElement("div", { id: "bk-card-container" }), !payReady && !payInitError && /* @__PURE__ */ React.createElement("p", { style: { fontFamily: "var(--mono)", fontSize: 10, letterSpacing: "0.1em", color: "var(--ink-faint)", textTransform: "uppercase", padding: "4px 0 14px", margin: 0 } }, "Loading secure payment form\u2026"), payInitError && /* @__PURE__ */ React.createElement("p", { style: { fontFamily: "var(--body)", fontSize: 13, color: "var(--accent)", padding: "2px 0 14px", margin: 0, lineHeight: 1.5 } }, payInitError), payReady && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 6, padding: "2px 0 12px", opacity: 0.6 } }, /* @__PURE__ */ React.createElement("svg", { width: "12", height: "12", viewBox: "0 0 32 32", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("rect", { x: "2", y: "2", width: "28", height: "28", rx: "6.5", fill: "var(--ink)" }), /* @__PURE__ */ React.createElement("rect", { x: "11.5", y: "11.5", width: "9", height: "9", rx: "2.5", fill: "var(--paper)" })), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--mono)", fontSize: 10, letterSpacing: "0.1em", color: "var(--ink-soft)", textTransform: "uppercase" } }, "Powered by Square"))), payError && /* @__PURE__ */ React.createElement("p", { style: { fontFamily: "var(--mono)", fontSize: 11, color: "var(--accent)", letterSpacing: "0.08em", marginTop: 10, lineHeight: 1.5 } }, payError)), props.error && /* @__PURE__ */ React.createElement("p", { style: { fontFamily: "var(--mono)", fontSize: 11, color: "var(--accent)", letterSpacing: "0.08em", marginBottom: 14, lineHeight: 1.5 } }, props.error), /* @__PURE__ */ React.createElement(BkBtn, { onClick: function() {
        confirm(false);
