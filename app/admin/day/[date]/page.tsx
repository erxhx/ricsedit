  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* Back to week */}
        <Link href="/admin?tab=week" style={{
        ...
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 16 }}>
          <Link href={`/admin/day/${shiftDay(date, -1)}`} style={{
            color: '#4a4844', textDecoration: 'none', fontSize: 20, lineHeight: 1,
            WebkitTapHighlightColor: 'transparent',
          }}>‹</Link>

          <span style={{ fontFamily: 'var(--font-body)', fontSize: 13, color: '#ece9e2', whiteSpace: 'nowrap' }}>
            {fmtDate(date)}
          </span>
